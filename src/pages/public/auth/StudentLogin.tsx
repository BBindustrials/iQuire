...
import loginStudentImg from '../../../assets/images/auth/login-student.jpg';
...
export const StudentLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Phase 7 will redirect to /student/dashboard
  };
  ...
  if (submitSuccess) {
    return (
      <AuthLayout image={loginStudentImg} imageAlt="Student login success">
  ...
  return (
    <AuthLayout
      image={loginStudentImg}
      imageAlt="African student logging in to IQuire"
    >
      <AuthPageTitle
        title="Login"
        subtitle="Welcome back. Continue your journey with IQuire."
      />
